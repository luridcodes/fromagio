...
public class Utils {
     ...
     *
     * <p> This method loads all bytes from the specific file path and
     * converts them into a String using the platform's default character
     * encoding. Intended for small text-based resources like shader files
